...
def create_ashare_mcp_server(get_arena: Callable[[], ArenaService]) -> FastMCP:
    ...
    @mcp.tool(
        description=(
            ...
            "15:00. Set next_open=true before 09:28 to queue a request for the "
            "current trading day's open, or after 15:00 to queue one for the next "
            "trading day. It becomes a normal order from 09:28 and is "
