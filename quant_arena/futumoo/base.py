"""Futumoo-local arena scaffolding.

This is intentionally copied into the Futumoo arena instead of shared with
other arenas. It owns Futumoo agent registry, persisted state, daily reports,
...
class FutumooArenaBase:
    """Futumoo-local arena scaffolding. See module docstring for the contract."""
    ...
    def _compute_day_return_pct(
        self, state: FutumooAgentState, portfolio: PortfolioSnapshot
    ) -> float | None:
    ...
    def _update_today_equity_point(self, state: FutumooAgentState) -> None:
    ...
    def _freeze_today_equity(self, state: FutumooAgentState) -> None:
